...
const CompletePassModal = ({
  ...
  return (
    <Modal modalOpenStates={modalOpenStates} handleClose={handleClose}>
      ...
      >
        Complete Exchange with {pass?.added_by_member.name}
      </Typography>
      <Typography
        variant="body1"
        component="div"
      ...
      >
        ...
        {pass?.added_by_member.name}'s guest to your list.
      </Typography>
      <Typography
        variant="body1"
        component="div"
      ...
      >
        I have added {pass?.added_by_member.name}'s guest to the list
      </Button>
    </Modal>
  );
};
